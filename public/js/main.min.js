...
angular.module("angular-lightweight-markdown-editor-templates",[]).run(["$templateCache",function(t){t.put("angular-lightweight-markdown-template.html",'<div class="markdown-editor"><ul class="markdown-editor__actions"><li ng-repeat="control in markdownEditorCtrl.options.controls track by $index" ng-click="markdownEditorCtrl.action(control)" ng-class="{separator: control == \'separator\'}" ng-if="control != \'preview\'"><i ng-if="control != \'separator\'" class="{{markdownEditorCtrl.icons[control]}}"></i></li><li ng-if="markdownEditorCtrl.options.controls.indexOf(\'preview\') > -1" ng-click="markdownEditorCtrl.preview = !markdownEditorCtrl.preview" ng-show="markdownEditorCtrl.showdownEnabled" ng-class="{enabled: markdownEditorCtrl.preview}" class="preview">{{markdownEditorCtrl.translations.textPreview}}</li></ul><div class="markdown-editor__editorarea"><div ng-class="{nopreview: !markdownEditorCtrl.preview}"><textarea ng-model="markdownEditorCtrl.ngModel"></textarea></div><div class="markdown-editor__editorarea__preview" ng-if="markdownEditorCtrl.showdownEnabled" ng-show="markdownEditorCtrl.preview" ng-bind-html="markdownEditorCtrl.getHTML()"></div></div></div>')}]),function(){function t(){return{restrict:"E",templateUrl:"angular-lightweight-markdown-template.html",controller:e,controllerAs:"markdownEditorCtrl",scope:!0,bindToController:{ngModel:"=",textPreview:"@",textProvideText:"@",textProvideLink:"@",showPreview:"=",options:"="},require:["^form","ngModel"],link:function(t,e,r,i){n=e.find("textarea")[0];var o=(i[0],["name","required","minLength","maxLength","placeholder","selectionDirection","selectionStart","selectionEnd","spellcheck"]);angular.forEach(o,function(t){r[t]&&(n[t]=r[t])})}}}function e(t){this.preview=!1,"undefined"!=typeof this.showPreview&&(this.preview=this.showPreview),this.showdownEnabled="undefined"!=typeof showdown;for(var e in o)angular.isDefined(this[e])&&(o[e]=this[e]);this.translations=o,this.action=function(t){var e=l[t](this.ngModel,r());e!==!1&&(this.ngModel=e)},this.getHTML=function(){return this.showdownEnabled?t.trustAsHtml(s.makeHtml(this.ngModel)):""},this.options=angular.extend({},a,this.options),this.icons=u}function r(){return{start:n.selectionStart,end:n.selectionEnd,length:n.selectionEnd-n.selectionStart}}angular.module("angular-lightweight-markdown-editor",["ngSanitize","angular-lightweight-markdown-editor-templates"]).directive("markdownEditor",t);var n,o={textPreview:"Preview",textProvideText:"Please provide link text",textProvideLink:"Please provide link URL"};if("undefined"!=typeof showdown)var s=new showdown.Converter;var a={controls:["bold","italic","strikethrough","separator","heading","bullets","indent","code","separator","link","quote","separator","preview"]};e.$inject=["$sce"];var l={bold:function(t,e){return 0==e.length?t:d.surround(t,e.start,e.end-e.start,"**","**")},italic:function(t,e){return 0==e.length?t:d.surround(t,e.start,e.end-e.start,"*","*")},bullets:function(t,e){return d.startLinesWith(t,e.start,e.end,"* ")},heading:function(t,e){return d.startLinesWith(t,e.start,e.end,"#")},strikethrough:function(t,e){return 0==e.length?t:d.surround(t,e.start,e.end-e.start,"--","--")},indent:function(t,e){return d.startLinesWith(t,e.start,e.end,"\t")},quote:function(t,e){return d.startLinesWith(t,e.start,e.end,"> ")},code:function(t,e){if(0==e.length)return t;var r=t.substr(0,e.start).lastIndexOf("\n")+1,n=t.substr(e.end).indexOf("\n");if(-1==n)var i=t.length;else var i=e.end+n+1;return[t.substr(0,r),"```\n",t.substr(r,i-r),"\n```\n",t.substr(i)].join("")},link:function(t,e){if(e.length>0)var r=t.substr(e.start,e.length);else{var r=prompt(o.textProvideText);if(!r)return!1}var n=prompt(o.textProvideLink);return!!n&&[t.substr(0,e.start),"["+r+"]","("+n+")",t.substr(e.end)].join("")}},d={surround:function(t,e,r,n,i){var o=t.substr(e,r);return[t.substr(0,e),n?n:"",o,i?i:"",t.substr(e+r)].join("")},startLinesWith:function(t,e,r,n){var i=d.indexes(t.substr(e,r-e),"\n",e),o=t.substr(0,e).lastIndexOf("\n")+1;t=[t.substr(0,o),n,t.substr(o)].join("");for(var s=0;s<i.length;s++)t=[t.substr(0,n.length*(s+1)+i[s]+1),n,t.substr(n.length*(s+1)+i[s]+1)].join("");return t},indexes:function(t,e,r){var n=[];for(i=0;i<t.length;++i)t.substring(i,i+e.length)==e&&n.push(i+r);return n}},u={bold:"ame-bold",italic:"ame-italic",strikethrough:"ame-strikethrough",heading:"ame-header",bullets:"ame-list-ul",indent:"ame-indent",code:"ame-code",link:"ame-link",quote:"ame-quote-right"}}();
"use strict";angular.module("oi.file",[]).value("oiFileConfig",{change:function(e){e.$upload(this.url,{})},validate:function(e,t){var a=[];return"object"==typeof t&&(null!==t.allowedType&&t.allowedType.indexOf(e[this.fileName].toLowerCase().split(".").pop())!==-1||a.push({msg:t.errorBadType,code:"type"}),e[this.fileSize]>(+t.maxSize?t.maxSize:1/0)&&a.push({msg:t.errorBigSize,code:"size"}),e[this.fileSize]>(+t.maxSpace?t.maxSpace:1/0)-t.space&&a.push({msg:t.errorMaxSize,code:"full"}),t.maxNumberOfFiles&&t.quantity>=t.maxNumberOfFiles&&a.push({msg:t.errorMaxQuantity,code:"quantity"})),!!a.length&&a},setError:function(e,t){var a=t.data,r=a?a.error?[a.error]:a:[];if(!r.length)switch(e){case"drop":r.push({msg:"Drag and drop is not supported. Upgrade your browser",code:e});break;case"validate":r.push({msg:"The file is invalid",code:e});break;case"preview":r.push({msg:"Thumbnails are not supported. Upgrade your browser",code:e});break;case"load":r.push({msg:"Unable to load file. No connection to the Internet",code:e});break;case"upload":r.push({msg:"Unable to load file. Server problem",code:e});break;case"abort":r.push({msg:"Download aborted",code:e})}return t.item[this.fileLoaded]&&(delete t.item[this.fileLoaded],delete t.item[this.fileProgress],delete t.item[this.fileUploading]),{item:t.item,response:r}},url:"uploader.php",fieldName:"Files",fileClass:"dragover-file",notFileClass:"dragover-plain",fileName:"filename",fileThumb:"thumb",fileSize:"size",fileLoaded:"loaded",fileProgress:"progress",fileUploading:"uploading",queue:"uploading"}).directive("oiFile",["oiFileConfig","$q","$compile","$timeout",function(e,t,a,r){var i=[];return{link:function(r,l,o){function n(e){if("function"==typeof c.change){if(angular.isElement(e)){var t=angular.element(e),i=angular.element('<form style="display: none;" />'),l=angular.element('<iframe src="javascript:false;" name="iframeTransport'+ +new Date+'">'),o=a(t.clone())(r),n=t.val();e=[{lastModifiedDate:null,size:null,type:"like/"+n.replace(/^.+\.(?!\.)|.*/,""),name:n.match(/[^\\]+$/)[0],_form:i}],t.after(o).after(i),i.append(t).append(l)}r.$apply(function(t){for(var a=0,r=e.length;a<r;a++){var i={$upload:d,$preview:s,$abort:f,_file:e[a]};i[c.fileName]=e[a].name,i[c.fileThumb]=e[a].thumb,i[c.fileSize]=e[a].size,i[c.fileLoaded]=0,i[c.fileProgress]=0,i[c.fileUploading]=!0,c.change(i)}})}}function s(e,a){var i=t.defer(),l={item:e,response:{}};if(a=a?a:c.fileThumb,null!==window.FileReader){var o=new FileReader;o.onload=function(t){return function(t){t.target.result.indexOf("data:image")!==-1&&r.$apply(function(){e[a]=o.result,l.response[a]=o.result,i.resolve(l)})}}(this),o.readAsDataURL(this._file)}else"function"==typeof c.preview&&i.reject(c.setError("preview",{item:e,response:null}));return i.promise}function d(e,a,r){function l(){i.length?(i[0].item._file._form?p(i[0]):u(i[0]),i[0].deferred.promise["finally"](function(){i.shift(),l()})):(delete i.total,delete i.loaded,delete i.all,delete i.progress)}var o=t.defer();a=angular.extend(a,this),delete a.$upload,delete a.$preview;var n=c.validate(a,r);if(n)return o.reject(c.setError("validate",{item:a,data:n})),o.promise;var s={url:e,item:a,deferred:o,xhr:void 0};return i.push(s),1===i.length?(i.total=a[c.fileSize],i.loaded=0,i.progress=0,i.all=1,l()):(i.total+=a[c.fileSize],i.all++),o.promise}function f(){angular.forEach(i,function(e,t){e.item===this&&(e.xhr?setTimeout(function(){e.xhr.abort()},0):i.splice(t,1),i.total-=e.item[c.fileSize],i.loaded-=e.item[c.fileLoaded],i.all--)},this)}function u(e){var t=new XMLHttpRequest,a=new FormData;t.item=e.item,e.xhr=t,a.append(c.fieldName,e.item._file,e.item.filename),t.upload.addEventListener("progress",function(a){r.$apply(function(){e.item[c.fileLoaded]=a.lengthComputable?a.loaded:void 0,e.item[c.fileProgress]=a.lengthComputable?Math.round(100*a.loaded/a.total):void 0,i.loaded+=e.item[c.fileLoaded],i.progress=Math.round(100*i.loaded/i.total),t.data=a,e.deferred.notify(t)})},!1),t.addEventListener("load",function(){var a=t.data=m(t.responseText);delete e.item._file,delete e.item.$abort,delete e.item[c.fileProgress],delete e.item[c.fileLoaded],delete e.item[c.fileUploading],r.$apply(function(){200===t.status&&a?(angular.extend(e.item,a),e.deferred.resolve(t)):e.deferred.reject(c.setError("upload",t))})},!1),t.addEventListener("error",function(){t.data=m(t.responseText),r.$apply(function(){e.deferred.reject(c.setError("load",t))})},!1),t.addEventListener("abort",function(){t.data=m(t.responseText),r.$apply(function(){e.deferred.reject(c.setError("abort",t))})},!1),t.open("POST",e.url,!0),angular.forEach(e.item._file.headers,function(e,a){t.setRequestHeader(a,e)}),t.send(a)}function p(e){e.xhr=!1;var t=e.item._file._form,a=t.find("iframe"),i=t.find("input");i.prop("name",c.fieldName),t.prop({action:e.url,method:"post",target:a.prop("name"),enctype:"multipart/form-data",encoding:"multipart/form-data"}),a.bind("load",function(){var i,l;try{if(i=a.contents(),!i.length||!i[0].firstChild)throw new Error;l=angular.element(i[0].body).text(),i=m(l)}catch(o){}t.remove(),delete e.item._file,r.$apply(function(){i&&!i.error?(angular.extend(e.item,i),e.deferred.resolve({item:e.item,response:i})):e.deferred.reject(c.setError("upload",{responseText:l,data:i,item:e.item,dummy:!0}))})}),t[0].submit()}function m(e){if("object"!=typeof e)try{return angular.fromJson(e)}catch(t){return!1}return e}var c={};angular.extend(c,e),r.$watch(o.oiFile,function(t,a){c=angular.extend({},e,t)},!0),r[c.queue]=i,l.bind("drop",function(e){var t=e.dataTransfer?e.dataTransfer:e.originalEvent.dataTransfer;e.stopPropagation(),e.preventDefault(),t.files?n(t.files):c.setError("drop"),l.removeClass(c.fileClass+" "+c.notFileClass)}).bind("dragover",function(e){var t=e.dataTransfer?e.dataTransfer:e.originalEvent.dataTransfer;e.stopPropagation(),e.preventDefault(),t.dropEffect="copy",t&&t.types&&(t.types instanceof Array?t.types.indexOf("Files")>=0?l.addClass(c.fileClass):l.addClass(c.notFileClass):t.types.contains("Files")?l.addClass(c.fileClass):l.addClass(c.notFileClass))}).bind("dragleave",function(e){e.stopPropagation(),e.preventDefault(),l.removeClass(c.fileClass+" "+c.notFileClass)}).bind("change",function(){n(this.files?this.files:this)})}}}]);
